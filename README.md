...
[![Stiahnuť .vsix](https://img.shields.io/badge/⬇%20Stiahnuť%20.vsix-v0.6.0-007ACC?style=for-the-badge&logo=visualstudiocode&logoColor=white)](https://github.com/DITEC-Sopko/vscode-autotest-agent/raw/main/autotest-agent-0.6.0.vsix)
...
1. Stiahni súbor `autotest-agent-0.6.0.vsix`.
...
```bash
code --install-extension autotest-agent-0.6.0.vsix
```
